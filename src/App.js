...
const App = () =>{
    ...
    return (
      <View style={styles.app}>
       ...
       <View>
         <Text style={styles.customStyle}> Below is a custom hook for the
          <Text style={styles.italic}> useReducer</Text> 
          hook</Text>
           <br />
          <Text>Have a look at the <Link style={styles.customLink} href="https://channel.com">Confluence page</Link></Text>
         <br />
         </View>
         <Text>Count {state.count} </Text>
        <Button onPress={() => dispatch({type: 'increment'})} title="Increment" />
        <Button onPress={() => dispatch({type: 'decrement'})}  title="Decrement" />
        <Button onPress={() => {}} title="Increment Odd" />
        <Button onPress={() => {}} title="Fibonacci" />
      </View>
    );
  }
